...
export const enUS: TranslationSchema = {
  ...
  inspector: {
    ...
    paragraph_head_no: 'Same paragraph as previous',
    paragraph_first_locked_hint: 'The first segment is always a paragraph head',
    gap_after_manual: 'manual',
    gap_after_auto: 'auto',
    gap_after_unset: 'unset',
    gap_after_unset_hint:
      'No explicit gap. Export uses ExportEffects.silencePaddingMs as fallback.',
    ...
    take_trim_clear_hint: 'Clear trim (use full take)',
    btn_play: 'Play',
    btn_stop: 'Stop',
    btn_record: 'Record',
