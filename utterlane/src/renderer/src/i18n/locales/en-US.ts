...
export const enUS: TranslationSchema = {
  ...
  inspector: {
    ...
    field_gap_after: 'Trailing gap',
    paragraph_head_yes: 'Paragraph head',
    paragraph_head_no: 'Continuation',
    paragraph_first_locked_hint: 'The first segment is always a paragraph head',
    gap_after_follow_global: 'Follow global',
    gap_after_follow_global_hint:
      'Checked: this gap can be overwritten by "Apply default gaps". Unchecked: this is a manual value, default-apply skips it.',
    gap_after_clear_hint: 'Clear gap (revert to unset)',
  ...
  timeline: {
    ...
    btn_play_from_head: 'Play from segment start',
    ...
    zoom_slider_hint: 'Drag to zoom · double-click to reset · Ctrl+wheel on the timeline',
    zoom_h_slider_hint:
      'Horizontal zoom — drag to scale time axis · double-click to reset · Ctrl+wheel on the waveform',
    zoom_v_slider_hint:
    ...
    btn_resume_project: 'Resume',
    btn_speed_minus: 'Speed -0.25x',
    btn_speed_plus: 'Speed +0.25x',
    speed_select_hint: 'Current {{rate}}x · pick a preset or step with ±',
  ...
  preferences: {
    ...
    section_editor_theme: 'Editor colors',
    section_project_defaults: 'New project defaults',
    section_recording: 'Recording',
    label_theme_preset: 'Preset theme',
    theme_preset_dark: 'Dark',
    theme_preset_light: 'Light',
    theme_preset_highContrast: 'High contrast',
    theme_overrides_label: 'Color overrides (on top of preset)',
    theme_reset_overrides: 'Reset',
    theme_reset_overrides_hint: 'Clear all custom overrides, back to pure preset',
    theme_token_overridden: 'Overridden from preset',
