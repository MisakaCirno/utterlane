...
export const enUS: TranslationSchema = {
  ...
  timeline: {
    ...
    zoom_h_in: 'Zoom in horizontally (Ctrl+wheel)',
    zoom_h_out: 'Zoom out horizontally (Ctrl+wheel)',
    zoom_h_reset: 'Reset horizontal zoom',
    zoom_v_in: 'Zoom in vertically (Ctrl+Shift+wheel)',
    zoom_v_out: 'Zoom out vertically (Ctrl+Shift+wheel)',
    zoom_v_reset: 'Reset vertical zoom',
